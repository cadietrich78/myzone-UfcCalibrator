...
namespace my {
    ...
    public:
        ...
        CTimestamp(my::int64 secondsFromEpoch);
        ...
        std::string GetMonthAsShortString() const;
        INT32 GetDay() const;
        ...
        void AddHours(my::int64 hours);

        void AddMinutes(my::int64 minutes);

        void AddSeconds(my::int32 seconds);
        void AddSeconds(double seconds);

        void AddMilliseconds(my::int64 milliseconds);
        ...
        INT64 DifferenceInMicroseconds(CTimestamp timestamp) const;
    ...
    */
    ...
    {
        // Groundhog Day
        return CTimestamp(1993, 2, 2, 6, 0, 0, 0, 0);
    }
}; // my
