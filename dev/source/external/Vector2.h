...
namespace my {
    ...
    public:
        ...
        // BUG! (10-Jun-2019) CALLS FOR THE CVector2(x, y) CONSTRUCTOR WERE ENDING HERE!
        //CVector2(T value)
        //    : m_x(value),
        //    m_y(value),
        //    m_invalidValue(my::Null<T>())
        ...
        CVector2 Scale(const T scale) const
        {
#if defined(_DEBUG)
            if (!IsValid())
                LOG_ERROR();
        ...
        // BUG! (10-Jun-2019) CALLS FOR THE CVector2 operator*(const CVector2& vector2) OPERATOR WERE ENDING HERE!
...
//        }
        ...
        CVector2 operator/(const CVector2& rhs) const
        {
            ...
            if (MyMath::IsZero(rhs.m_x) ||
                MyMath::IsZero(rhs.m_y))
            {
                LOG_ERROR();
            }
...
//#endif //#if defined(_DEBUG)
        ...
        // DEGREES
        T Angle(const CVector2& vector2) const
        {
#if defined(_DEBUG)
            if (!IsValid())
                LOG_ERROR();
