...
namespace UnitConversion
{
    ...
    */
    template <typename T>
    T MillisecondToMicrosecond(T msec);

    /**
    */
    template <typename T>
    T Millisecond2Minute(T msec);
    ...
    */
    template <typename T>
    T Centimeters2Feet(T centimeters);
    ...
    */
    ...
    {
        return millimiter * (T)0.0032808398950131;
    }
    ...
    */
    ...
    // One Joule is 1 Newton/meter, ie the work done or energy transfered to an object when a one Newton force acts on it over one meter. It can also be defined as the heat energy dissipated by a current of one ampere passing through a one Ohm resistor for one second. 
    // One foot pound is the work done by a force of one pound acting through a distance of one foot, in the direction of the force.
    template <typename T>
    T JoulesToFootPounds(T joules)
    {
    ...
    */
    template <typename T>
    T KilogramsToPounds(T kilograms);

    /**
    */
    template <typename T>
    T PoundsToKilograms(T pounds);
};
