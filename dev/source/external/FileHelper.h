...
namespace my {
    namespace file {
        ...
        // timeout: the maximum time in seconds that you allow the transfer operation to take.
        bool UploadToFtp(std::string fileName, std::string url, std::string user = my::Null<std::string>(), std::string password = my::Null<std::string>(), my::int32 timeout = my::Null<my::int32>());

        // FTP TO FILE (https://curl.haxx.se/libcurl/c/ftpget.html)
        // timeout: the maximum time in seconds that you allow the transfer operation to take.
        bool GetFromFtp(std::string fileName, std::string url, std::string user = my::Null<std::string>(), std::string password = my::Null<std::string>(), my::int32 timeout = my::Null<my::int32>());
