...
#if defined(_DEBUG)
    m_timeAsString = boost::posix_time::to_iso_extended_string(m_time);
#endif //#if defined(_DEBUG)
...
// CASTING!
void my::CTimestamp::Set(my::int64 secondsFromEpoch)
{
    my::int64 microseconds = 0,
        milliseconds = 0;

    // TRICKY: (01-Jul-2015) Microseconds (Wed, 16 Nov 5138 09:46:39 GMT)
    if (secondsFromEpoch > 99999999999999LL)
    {
        microseconds = secondsFromEpoch % 1000LL;

        secondsFromEpoch /= 1000LL;
    }
    // TRICKY: (01-Jul-2015) Microseconds (Wed, 16 Nov 5138 09:46:39 GMT)
    if (secondsFromEpoch > 99999999999LL)
    {
        milliseconds = secondsFromEpoch % 1000LL;
...
/**
*/
std::string my::CTimestamp::GetMonthAsShortString() const
{
    return m_time.date().month().as_short_string();
}
...
{
    my::int64 hours = m_time.time_of_day().hours();

#if defined(_DEBUG)
    if (hours != (my::int32)hours)
        LOG_ERROR();
#endif //#if defined(_DEBUG)

    return (my::int32)hours;
}
...
{
    my::int64 minutes = m_time.time_of_day().minutes();

#if defined(_DEBUG)
    if (minutes != (my::int32)minutes)
        LOG_ERROR();
#endif //#if defined(_DEBUG)

    return (my::int32)minutes;
}
...
{
    my::int64 seconds = m_time.time_of_day().seconds();

#if defined(_DEBUG)
    if (seconds != (my::int32)seconds)
        LOG_ERROR();
#endif //#if defined(_DEBUG)

    return (my::int32)seconds;
}
...
/**
*/
void my::CTimestamp::AddHours(my::int64 hours)
{
...
/**
*/
void my::CTimestamp::AddMinutes(my::int64 minutes)
{
...
/**
*/
void my::CTimestamp::AddSeconds(my::int32 seconds)
{
...
{
    m_time += boost::posix_time::microseconds((my::int64)(1000000.0 * seconds));
...
/**
*/
void my::CTimestamp::AddMilliseconds(my::int64 milliseconds)
{
...
/**
*/
INT64 my::CTimestamp::DifferenceInMicroseconds(CTimestamp timestamp) const
{
...
#if defined(_DEBUG)
    m_timeAsString = timestamp.m_timeAsString;
#endif //#if defined(_DEBUG)
}
